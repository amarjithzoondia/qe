//
//  ObservationItemContentView.swift
// QualityExpertise
//
...
struct ObservationListRowView: View {
    let viewModel: ObservationListRowViewModel
...
struct ObservationListRowView_Previews: PreviewProvider {
    static var previews: some View {
        ObservationListRowView(viewModel: .init(observation: Observation.dummy(observationId: -1)))
    }
}
