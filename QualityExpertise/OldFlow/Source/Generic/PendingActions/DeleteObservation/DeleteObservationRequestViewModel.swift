//
//  DeleteObservationViewModel.swift
// ALNASR
//
...
class DeleteObservationRequestViewModel: BaseViewModel, ObservableObject {
    ...
    func requestToDeleteObservation(justification: String, completion: @escaping (_ completed: Bool) -> ()) {
        do {
            let justification = try justification.validatedText(validationType: .requiredField(field: "Description"))
