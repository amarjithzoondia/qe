//
//  CreateInspectionImageView.swift
//  ALNASR
//
...
struct CreateInspectionImageView: View {
    ...
    @StateObject var viewModel: CreateInspectionImageViewModel
            ...
            ZStack {
                VStack {
                    HStack {
                        ...
                        Button { minusButtonTapped() } label: {
                    ...
                    .disabled(isViewOnly)
                    .onChange(of: description, perform: descriptionChanged)
                    .padding(.top, 20.5)
                    .padding(.bottom, 39.5)
                }
