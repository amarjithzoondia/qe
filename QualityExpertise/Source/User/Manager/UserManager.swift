...
final class UserManager: ObservableObject {
    ...
    static let IS_GROUP_ADMIN = "IS_GROUP_ADMIN"
    ...
    static func saveIsGroupAdmin(isGroupAdmin: Bool) {
        UserDefaults.standard.set(isGroupAdmin, forKey: IS_GROUP_ADMIN)
    }
    
    static func getIsGroupAdmin() -> Bool {
        return UserDefaults.standard.bool(forKey: IS_GROUP_ADMIN)
    }
...
//            LocalizationService.shared.language = .english
            UserManager.shared.notificationUnReadCount = 0
            UserManager.shared.pendingActionsCount = 0
        }
