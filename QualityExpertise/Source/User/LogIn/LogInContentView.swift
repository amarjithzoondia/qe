...
struct LogInContentView: View {
    ...
    fileprivate func scrollContent(in frame: CGRect) -> some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 0) {
                Text("lets_start_logging_in".localizedString())
                ...
                Button {
                    ...
                    Text("forgot_password".localizedString())
                        .foregroundColor(Color.Indigo.DARK)
                        .font(.medium(14))
                }
                .padding(.top, 43)
                ...
                HStack(spacing: 3) {
                    Text("no_account_question".localizedString())
                    ...
                    Button {
                        ...
                        Text("register_here".localizedString())
                ...
                Button {
                    ...
                    HStack {
                        Text("guest_user".localizedString())
                            .foregroundColor(Color.Black.DARK)
                            .font(.medium(13))
