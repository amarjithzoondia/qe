...
struct NFPendingActionRowView: View {
    let viewModel: NFPendingActionRowViewModel
...
struct NFPendingActionRowView_Previews: PreviewProvider {
    static var previews: some View {
        NFPendingActionRowView(viewModel: .init(pendingActionDetails: NFPendingActionDetails.dummy(id: -1)))
    }
}
