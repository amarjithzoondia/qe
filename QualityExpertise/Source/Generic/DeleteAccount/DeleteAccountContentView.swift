...
struct DeleteAccountContentView: View {
    ...
    var body: some View {
                    ...
                    if let error = viewModel.error {
                        ...
                        ScrollView {
                            ...
                            VStack(alignment: .center, spacing: 0) {
                                ...
                                Text("delete_account".localizedString())
                                    .font(.semiBold(17))
                                ...
                                if !viewModel.isGuestUser {
                                    ...
                                    if viewModel.deletionContent != nil {
                                        ...
                                        Text("enter_otp_sent_to_mail".localizedString())    .font(.light(12))  .foregroundColor(Color.Blue.BLUE_GREY)
                                            .padding(.top, 20)
                                        ...
                                        }, title: "submit".localizedString(), titleColor: .white, width: screenWidth  - (46 * 2), height: 45, backgroundColor: Color.Blue.THEME, isLoading: $viewModel.isButtonLoading)
                                    }
                                } else {
                                    ButtonWithLoader(action: {
                                        showConfirmationAlert.toggle()
                                    }, title: "confirm".localizedString(), titleColor: .white, width: screenWidth  - (46 * 2), height: 45, backgroundColor: Color.Blue.THEME, isLoading: $viewModel.isButtonLoading)
                                }
                            }
        ...
        .pickerViewerOverlay(viewerShown: $showConfirmationAlert, title: "confirm_deletion".localizedString()) {
            
            VStack {
                LeftAlignedHStack(
                    Text("confirm_deletion_message".localizedString())
