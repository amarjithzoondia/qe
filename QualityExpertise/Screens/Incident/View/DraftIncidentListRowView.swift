//
//  DraftIncidentListRowView.swift
//  ALNASR
//
...
struct DraftIncidentListRowView: View {
    private let viewModel = DraftIncidentListRowViewModel()
...
struct DraftIncidentListRowView_Previews: PreviewProvider {
    static var previews: some View {
        DraftIncidentListRowView(incident: .dummmy(), minusButtonTapped: {})
    }
}
