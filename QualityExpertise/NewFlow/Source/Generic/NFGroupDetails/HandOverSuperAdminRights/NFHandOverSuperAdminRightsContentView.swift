//
//  NFHandOverSuperAdminRightsContentView.swift
//  QualityExpertise
//
...
struct NFHandOverSuperAdminRightsContentView: View {
        ...
        ZStack {
            ...
            VStack {
                ...
                VStack {
                    ...
                    LeftAlignedHStack(
                        Text("Who would you like to hand over your admin privilages to?")
                        ...
                        VStack {
                            Button {
                                viewControllerHolder?.present(style: .overCurrentContext) {
                                    NFUserListContentView(viewModel: .init(groupData: groupDetails), isFromSelectAUser: true, isFromViewGroup: true, isUserActive: $isUserSelect, isUserActiveForNotification: .constant(false), userData: $userData, userDatas: .constant([UserData.dummy()]), forAvoidUser: true)
                                        .localize()
                                }
                            } label: {
                                Text("Select User")
