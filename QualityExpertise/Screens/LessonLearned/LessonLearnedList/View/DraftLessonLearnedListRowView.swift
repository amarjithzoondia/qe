//
//  DraftLessonLearnedListRowView.swift
// QualityExpertise
//
...
struct DraftLessonLearnedListRowView: View {
    private let viewModel = DraftLessonLearnedListRowViewModel()
...
struct DraftLessonLearnedListRowView_Previews: PreviewProvider {
    static var previews: some View {
        DraftLessonLearnedListRowView(lesson: .dummy(), minusButtonTapped: {})
    }
}
