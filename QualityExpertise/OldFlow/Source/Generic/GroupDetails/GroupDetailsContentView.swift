...
struct GroupDetailsContentView: View {
    ...
    var body: some View {
                            ...
                            if viewModel.groupDetails?.userRole == .superAdmin {
                                VStack(spacing: 21) {
                                    Button {
                                        ...
                                        Text("Handover Super Admin Rights")
        ...
        .pickerViewerOverlay(viewerShown: $alertShownForHandOver, title: "Confirm") {
            VStack {
                LeftAlignedHStack(
                    Text("Hand over Admin rights to \(userName)?")
        ...
        .pickerViewerOverlay(viewerShown: $alertShownForDeleteGroup, title: "Delete Group !!") {
            VStack {
                LeftAlignedHStack(
                    Text("Are you sure want to go ahead with this? If you continue, the transaction is irreversible.")
                        .foregroundColor(Color.Indigo.DARK)
                        .font(.regular(14))
                )
        ...
        .pickerViewerOverlay(viewerShown: $alertShownForExitGroup, title: "Exit Group !!") {
            VStack {
                LeftAlignedHStack(
                    Text("Are you sure you want to exit from this group?")
                        .foregroundColor(Color.Indigo.DARK)
                        .font(.regular(14))
                )
        ...
        VStack {
            ...
            if isSearchFieldActive {
                SearchFieldInputView(
                    ...
                    text: $searchText,
                    placeholder: "Search members ...".localizedString(),
