...
struct InviteUserContentView: View {
    ...
    var body: some View {
            ...
            ZStack {
                ...
                VStack {
                    VStack {
                        VStack(spacing: 18) {
                            LeftAlignedHStack(
                                Text("add_user_title".localizedString())
                            ...
                            LeftAlignedHStack(
                                Text("invite_description".localizedString())
                ...
                VStack {
                    ...
                    Button {
                        ...
                        if isFromDashboard {
                            Text("select_group".localizedString())
        ...
        .pickerViewerOverlay(viewerShown: $alertShown, title: "invitation_sent".localizedString()) {
            ...
            VStack {
                LeftAlignedHStack(
                    Text("invitation_sent_message".localizedString())
                        .foregroundColor(Color.Indigo.DARK)
                        .font(.regular(12))
                )
    ...
    func addEmailToList() {
        ...
        guard email.isValidEmail() else {
            viewModel.toast = Toast.alert(title: "Alert!", subTitle: "alert_invalid_email".localizedString(), displayMode: .banner(.slide), isSuccess: false)
            return viewModel.showToast = true
        }
