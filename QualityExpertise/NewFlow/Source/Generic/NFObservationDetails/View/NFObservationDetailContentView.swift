//
//  NFObservationDetailContentView.swift
//  ALNASR
//
...
struct NFObservationDetailContentView: View {
    @Environment(\.viewController) private var viewControllerHolder: UIViewController?
    @StateObject var viewModel: NFObservationDetailViewModel
    ...
    var body: some View {
                            ...
                            VStack(spacing: 0) {
                                ...
                                if viewModel.isGuestUser {
                                    if viewModel.guestObservationDetails.description != "" {
                                        LeftAlignedHStack(
                                            Text(viewModel.guestObservationDetails.description ?? "na".localizedString())
                                    ...
                                    if viewModel.observationDetails.description != "" {
                                        LeftAlignedHStack(
                                            Text(viewModel.observationDetails.description ?? "na".localizedString())
                                                .foregroundColor(Color.Blue.BLUE_GREY)
                                                .font(.light(12))
                                        )
                                            .padding(.top, 13.5)
                                ...
                                if viewModel.isGuestUser {
                                    if viewModel.guestObservationDetails.location != "" {
                                        HStack(spacing: 5) {
                                            ...
                                            Text(viewModel.guestObservationDetails.location ?? "na".localizedString())
                                    ...
                                    if viewModel.observationDetails.location != "" {
                                        HStack(spacing: 5) {
                                            ...
                                            Text(viewModel.observationDetails.location ?? "na".localizedString())
                                                .foregroundColor(Color.Blue.DARK_BLUE_GREY)
                                                .font(.medium(12))
        ...
        .pickerViewerOverlay(viewerShown: $showAlertForDeleteObservation, title: "confirm_delete".localizedString()) {
            VStack {
                LeftAlignedHStack(
                    Text("delete_confirmation_message".localizedString())
                        .foregroundColor(Color.Indigo.DARK)
                        .font(.regular(14))
                )
    ...
    var observationImageView: some View {
        VStack {
            LeftAlignedHStack(
                Text("image_and_description".localizedString())
    ...
    var reportedByView: some View {
        VStack(spacing: 12) {
            LeftAlignedHStack(
                Text("reported_by".localizedString().uppercased())
                    .foregroundColor(Color.Indigo.DARK)
                    .font(.semiBold(13))
            )
    ...
    var closeDetailsView: some View {
        VStack(spacing: 20) {
            HStack {
                Text("observation_closeout".localizedString())
                    .foregroundColor(Color.Indigo.DARK)
                    .font(.semiBold(19))
            ...
            LeftAlignedHStack(
                Text("closeout_description".localizedString())
                    .foregroundColor(Color.Grey.BLUEY_GREY)
                    .font(.regular(12))
            )
            ...
            if !viewModel.isGuestUser {
                LeftAlignedHStack(
                    Text("closed_by".localizedString())
                        .foregroundColor(Color.Indigo.DARK)
                        .font(.semiBold(13))
                )
    ...
    var DeleteObservationButtonView: some View {
        VStack {
            Button {
                ...
                Text("delete_observation".localizedString())
    ...
    func generatePdf() {
        viewModel.generatePdf { completed in
            viewModel.savePdfWithProgress(urlString: viewModel.pdfUrl, fileName: "ALNASR - Observation(\(viewModel.observationId)).pdf")
        }
    }
    ...
    func savePdf(urlString:String) {
        ...
        let pdfNameFromUrl = "ALNASR - Observation(\(viewModel.observationId)).pdf"
...
struct NFObservationDetailContentView_Previews: PreviewProvider {
    static var previews: some View {
        NFObservationDetailContentView(viewModel: .init(observationId: -1))
    }
}

extension NFObservationDetailContentView {
    struct ImageView: View {
        ...
        var body: some View {
            VStack {
                VStack {
                    LeftAlignedHStack(
                        Text(String(format: NSLocalizedString("image_with_count", comment: ""), count))
                            .foregroundColor(Color.Blue.DARK_BLUE_GREY)
                            .font(.medium(13))
                    )
