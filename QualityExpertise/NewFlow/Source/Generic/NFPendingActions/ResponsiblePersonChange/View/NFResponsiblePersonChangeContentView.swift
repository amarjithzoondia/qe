//
//  NFResponsiblePersonChangeContentView.swift
//  QualityExpertise
//
...
struct NFResponsiblePersonChangeContentView: View {
    @Environment(\.viewController) private var viewControllerHolder: UIViewController?
    @StateObject var viewModel: NFResponsiblePersonChangeViewModel
