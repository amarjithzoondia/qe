...
//        font(name: "Poppins-Medium", with: size)
    ...
    static func lightItalic(_ size: CGFloat = 12) -> Font {
        font(name: "Poppins-LightItalic", with: size)
    }
    
    static func poppinsItalic(_ size: CGFloat = 12) -> Font {
        font(name: "Poppins-Italic", with: size)
    }
    
    static func poppins(_ size: CGFloat = 12) -> Font {
        font(name: "Poppins-Regular", with: size)
    }
    
    static func poppinsMedium(_ size: CGFloat = 12) -> Font {
        font(name: "Poppins-Medium", with: size)
    }
...
//        return UIFont(name: "Poppins-Medium", size: size)!
    ...
    static func lightItalic(_ size: CGFloat = 12) -> UIFont {
        return UIFont(name: "Poppins-LightItalic", size: size)!
    }
    
    static func poppinsItalic(_ size: CGFloat = 12) -> UIFont {
        return UIFont(name: "Poppins-Italic", size: size)!
    }

    static func poppins(_ size: CGFloat = 12) -> UIFont {
        return UIFont(name: "Poppins-Regular", size: size)!
    }
    
    static func poppinsMedium(_ size: CGFloat = 12) -> UIFont {
        return UIFont(name: "Poppins-Medium", size: size)!
    }
