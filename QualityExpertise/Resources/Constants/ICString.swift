...
struct IC {
    ...
    struct ACTIONS {
        ...
        struct GREEN_RADIO_BUTTON {
            static let ON = "ic.green.radio.on"
            static let OFF = "ic.green.radio.off"
        }
    }
    ...
    struct HOMESCREEN {
        ...
        static let LESSON_LEARNED = "ic.home.lesson_learned"
    }
    
    struct VIOLATIONS {
        static let DRAFT = "ic.draft"
    }
}
