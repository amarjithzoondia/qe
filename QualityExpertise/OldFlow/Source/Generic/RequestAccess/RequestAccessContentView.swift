...
struct RequestAccessContentView: View {
    ...
    var body: some View {
        NavigationView {
            ZStack {
                ...
                ScrollView(showsIndicators: false) {
                    VStack {
                        ...
                        Text("Group Access Request")
                            .foregroundColor(Color.Indigo.DARK)
                            .font(.semiBold(21))
                            .padding(.top, 15)
                            .multilineTextAlignment(.center)
                        
                        Text("Please enter the code to join the Group")
                            .foregroundColor(Color.Indigo.DARK)
                            .font(.regular(13.5))
                            .padding(.top, 11.5)
                            .multilineTextAlignment(.center)
            ...
            .navigationBarTitle("Request Access", displayMode: .inline)
            .toolbar {
        ...
        .pickerViewerOverlay(viewerShown: $isViewGroup, title: viewModel.isGroupVerified ? "" : "Incorrect Code !!") {
            if viewModel.isGroupVerified {
                ...
                LeftAlignedHStack(
                    Text("Group that you requested to view does not exist.")
                        .foregroundColor(Color.Indigo.DARK)
                        .font(.regular(15))
                )
        ...
        .pickerViewerOverlay(viewerShown: $isRequestSuccess, title: viewModel.isGroupVerified ? "Access Requested" : "Incorrect Code !!") {
            if viewModel.isGroupVerified {
                LeftAlignedHStack(
                    Text("Group Access Requested")
                        .foregroundColor(Color.Indigo.DARK)
                        .font(.regular(15))
                )
                ...
                LeftAlignedHStack(
                    Text("Group that you requested to join does not exist.")
                        .foregroundColor(Color.Indigo.DARK)
                        .font(.regular(15))
                )
